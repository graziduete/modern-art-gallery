...
const artworksData: Record<string, {
  ...
  "4": {
    ...
    artist: "Roberto Lima",
    description: "Instalação que representa a interdependência dos seres vivos. Elementos vegetais secos, sementes e estruturas metálicas reaproveitadas compõem um ecossistema imaginário que evoca equilíbrio e transformação.",
    materials: "Madeira de reflorestamento, metal reciclado, fibras naturais, sementes",
    ...
    isForSale: true,
    price: "R$ 22.000",
    images: ["/images/artwork-4.jpg", "/images/artwork-5.jpg", "/images/artwork-6.jpg"],
  },
  "5": {
    id: "5",
    title: "Horizonte Invertido",
    artist: "Ana Beatriz Costa",
    description: "Pintura que subverte a paisagem tradicional. Camadas de tinta e colagem com materiais urbanos descartados criam um horizonte que reflete a complexidade das cidades contemporâneas.",
    materials: "Tinta acrílica, colagem com papel reciclado, tecido de reúso",
    dimensions: "120 x 90 x 5 cm",
    isAnamorphic: false,
    hasVideo: true,
    isRentable: true,
    isForSale: false,
    images: ["/images/artwork-5.jpg", "/images/artwork-7.jpg", "/images/artwork-8.jpg"],
  },
  "6": {
    id: "6",
    title: "Tecido da Cidade",
    artist: "Pedro Almeida",
    description: "Mixed media que entrelaça fios, tecidos e metais urbanos. A obra explora a textura das ruas e a memória têxtil das relações humanas nos espaços compartilhados.",
    materials: "Tecido de reúso, fios metálicos, fiação elétrica descartada",
    dimensions: "180 x 140 x 20 cm",
    isAnamorphic: false,
    hasVideo: false,
    isRentable: false,
    isForSale: true,
    price: "R$ 12.500",
    images: ["/images/artwork-6.jpg", "/images/artwork-1.jpg", "/images/artwork-2.jpg"],
  },
  "7": {
    id: "7",
    title: "Natureza Reconstruida",
    artist: "Fernanda Dias",
    description: "Escultura que reconstrói formas orgânicas a partir de materiais inorgânicos. Plásticos e metais descartados ganham nova vida como folhas, galhos e raízes de um jardim imaginário.",
    materials: "Plástico reciclado, metal, vidro reutilizado",
    dimensions: "160 x 100 x 80 cm",
    isAnamorphic: false,
    hasVideo: true,
    isRentable: true,
    isForSale: true,
    price: "R$ 18.000",
    images: ["/images/artwork-7.jpg", "/images/artwork-3.jpg", "/images/artwork-4.jpg"],
  },
  "8": {
    id: "8",
    title: "Janelas do Amanha",
    artist: "Lucas Ferreira",
    description: "Instalação com molduras e vidros recuperados de construções demolidas. Cada janela sugere um portal para futuros possíveis, onde o reúso e a memória se encontram.",
    materials: "Molduras de demolição, vidro recuperado, madeira",
    dimensions: "220 x 160 x 50 cm",
    isAnamorphic: false,
    hasVideo: false,
    isRentable: true,
    isForSale: false,
    images: ["/images/artwork-8.jpg", "/images/artwork-5.jpg", "/images/artwork-6.jpg"],
  },
  "9": {
    id: "9",
    title: "Ciclos Infinitos",
    artist: "Camila Rocha",
    description: "Escultura circular que evoca os ciclos da natureza e da reciclagem. Rodas, engrenagens e elementos mecânicos reaproveitados formam um movimento contínuo de transformação.",
    materials: "Engrenagens, rodas de bicicleta, metal reciclado",
    dimensions: "140 x 140 x 90 cm",
    isAnamorphic: false,
    hasVideo: true,
    isRentable: false,
    isForSale: true,
    price: "R$ 14.500",
    images: ["/images/artwork-1.jpg", "/images/artwork-2.jpg", "/images/artwork-3.jpg"],
  },
  "10": {
    id: "10",
    title: "Dialogo Silencioso",
    artist: "Rafael Souza",
    description: "Pintura que captura o silêncio entre as palavras. Camadas de tinta sobre madeira recuperada criam um diálogo visual sobre comunicação, ausência e presença.",
    materials: "Tinta óleo, madeira de demolição, resina",
    ...
    isForSale: true,
    price: "R$ 9.800",
    images: ["/images/artwork-2.jpg", "/images/artwork-4.jpg", "/images/artwork-6.jpg"],
  },
  "11": {
    id: "11",
    title: "Raizes Aereas",
    artist: "Isabela Martins",
    description: "Instalação que suspende raízes e ramos no ar, invertendo nossa percepção do crescimento. Materiais vegetais secos e estruturas metálicas formam uma paisagem flutuante.",
    materials: "Raízes e galhos secos, arame, estrutura metálica",
    dimensions: "300 x 200 x 150 cm",
    isAnamorphic: false,
    hasVideo: true,
    isRentable: true,
    isForSale: false,
    images: ["/images/artwork-3.jpg", "/images/artwork-5.jpg", "/images/artwork-7.jpg"],
  },
  "12": {
    id: "12",
    title: "Espelhos Quebrados",
    artist: "Thiago Nunes",
    description: "Mixed media com fragmentos de espelhos que multiplicam e fragmentam a realidade. Cada pedaço reflete uma perspectiva diferente, questionando a ideia de verdade única.",
    materials: "Espelhos quebrados, madeira, cola epóxi",
    dimensions: "130 x 90 x 15 cm",
    isAnamorphic: false,
    hasVideo: false,
    isRentable: false,
    isForSale: true,
    price: "R$ 11.200",
    images: ["/images/artwork-4.jpg", "/images/artwork-1.jpg", "/images/artwork-8.jpg"],
  },
